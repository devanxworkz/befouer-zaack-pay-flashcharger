...
const { chargerId, connectorId, sessionId } = useParams();
  ...
  // const dashOffset =
  // circumference - (animatedSoc / 100) * circumference;
  const actualOffset =
  circumference - (soc / 100) * circumference;
      ...
      <div className="gauge-container">
        <svg className="progress-ring" width="300" height="300">
         ...
         {/* FIXED ACTUAL SOC */}
          ...
          {isCharging && (
            <circle
              className="progress-ring-animation"
              strokeWidth="12"
              r={radius}
              cx="150"
              cy="150"
